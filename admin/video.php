...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="box">
                <?php if($_SESSION['type'] == 2): ?>
                    <div class="box-header with-border">
                        <a href="#addnew" data-toggle="modal" class="btn btn-success btn-sm btn-flat custom-btn"><i class="fa fa-plus"></i> New Video</a> 
                    </div>
                <?php endif; ?>
                <?php if($_SESSION['type'] == 0): ?>
                    <div class="box-header with-border">
                        <a href="bookmark_video.php" class="btn btn-success btn-sm btn-flat custom-btn"><i class="fas fa-bookmark"></i> Bookmark</a> 
                    </div>
                <?php endif; ?>
                <?php if($_SESSION['type'] == 2): ?>
                ...
                <?php if($_SESSION['type'] == 0): ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <?php 
                            $sql = "SELECT * FROM video WHERE category = 'Normal'";
                            $stmt = $this->conn()->query($sql);
                            while ($row = $stmt->fetch()) { 
                                $file = $row['file'];
                                $file_ext = pathinfo($file, PATHINFO_EXTENSION);
                                    ...
                                    <div class="card" style="border: 2px solid rgba(0, 0, 0, 0.1);padding: 20px;">
                                        ...
                                        <div style="display: flex;place-items: center;justify-content: space-between;">
                                            ...
                                            <h4>
                                                ...
                                                <?php 
                                                $sql2 = "SELECT * FROM bookmark_video WHERE users_id = ? AND video_id = ?";
                        ...
                        <div class="row">
                            ...
                            <?php 
                            $sql = "SELECT * FROM video WHERE category = 'Anxiety'";
                            $stmt = $this->conn()->query($sql);
                            while ($row = $stmt->fetch()) { 
                                $file = $row['file'];
                                $file_ext = pathinfo($file, PATHINFO_EXTENSION);
                        ...
                        <div class="row">
                            ...
                            <?php 
                            $sql = "SELECT * FROM video WHERE category = 'Depressed'";
                            $stmt = $this->conn()->query($sql);
                            while ($row = $stmt->fetch()) { 
                                $file = $row['file'];
                                $file_ext = pathinfo($file, PATHINFO_EXTENSION);
  ...
  <?php include 'modal/videoModal.php'; ?>
  <script>
